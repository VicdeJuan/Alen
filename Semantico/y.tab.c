...
{
  "$end", "error", "$undefined", "TOK_FLOAT", "TOK_ENTERO", "'+'", "'-'",
  "'*'", "'/'", "'('", "')'", "$accept", "exp_prn", "exp", "cte", YY_NULLPTR
};
#endif
...
#line 27 "bison.y" /* yacc.c:1646  */
    { printf("Resultado: %f",(yyvsp[0].float_val)); }
